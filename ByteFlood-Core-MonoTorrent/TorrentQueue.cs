...
//        private State ProgramState = null;
...
//        {
//            this.ProgramState = st;

//            this.slots = new Amib.Threading.SmartThreadPool();
//            this.set_queue_size(Program.Settings.QueueSize);
//            this.last_queue_enable_setting = Program.Settings.EnableQueue;
//        }
...
//                if (Program.Settings.QueueSize > this.slots.MinThreads)
//                {
//                    this.set_queue_size(Program.Settings.QueueSize);
//                }
//                else if (this.slots.MinThreads < Program.Settings.QueueSize)
//                {
//                    this.set_queue_size(Program.Settings.QueueSize);

//                    //then we need to stop x amount of torrents
//                    int how_much_to_stop = Program.Settings.QueueSize - this.slots.MaxThreads;
...
//                {
//                    this.last_queue_enable_setting = Program.Settings.EnableQueue;
//                    for (int i = 0; i < this.ProgramState.Torrents.Count; i++)
//                    {
//                        try
//                        {
//                            TorrentInfo ti = this.ProgramState.Torrents[i];
...
//                this.set_queue_size(this.ProgramState.Torrents.Count);
...
//        {
//            if (!Program.Settings.SeedingTorrentsAreActive && ti.IsComplete)
//            {
//                //simply start it
...
//                            else
//                            {
//                                //wait until something hProgramen, while keeping the queue busy
//                                Thread.Sleep(1000);
//                            }
//                        }
...
//                    {
//                        //this hProgramen if the torrent was {downloading} and it was {paused}.
...
//        {
//            if (Program.Settings.EnableQueue && queue_info_store.ContainsKey(ti.InfoHash))
//            {
...
//                     !Program.Settings.SeedingTorrentsAreActive && ti.Torrent.State == MonoTorrent.Common.TorrentState.Seeding;
//            }
//            return false;
//        }
