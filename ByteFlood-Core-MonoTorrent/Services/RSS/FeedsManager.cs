...
namespace ByteFlood.Services.RSS
{
    ...
    public static class FeedsManager
    {
        ...
        public static State AppState
        {
            ...
            {
                State s = null;
                ThreadPool.QueueUserWorkItem(delegate { s = Program.State; });
                return s;
            }
        }
        ...
        public static string RssTorrentsStorageDirectory
        {
            get
            {
                if (string.IsNullOrEmpty(Program.Settings.RssTorrentsStorageDirectory))
                {
                    return System.IO.Path.Combine(Program.Settings.DefaultDownloadPath, "RSS");
                }
                else
                {
                    return Program.Settings.RssTorrentsStorageDirectory;
                }
            }
        }
