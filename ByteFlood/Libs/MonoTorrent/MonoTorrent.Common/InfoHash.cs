...
namespace MonoTorrent
{
    public class InfoHash : IEquatable<InfoHash>
    {
        ...
        {
            return other == null || other.Length != 20 ? false : compare_array<byte>(Hash, other);
        }

        public static bool compare_array<T>(T[] a, T[] b)
        {
        ...
        public static bool operator ==(InfoHash left, InfoHash right)
        {
            ...
            if ((object)right == null)
                return false;
            return compare_array<byte>(left.Hash, right.Hash);
        }
        ...
        {
            return new InfoHash(Encoding.UTF8.GetBytes(System.Web.HttpUtility.UrlDecode(infoHash)));
        }
    }
}
